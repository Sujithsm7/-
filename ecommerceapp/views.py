...
def index(request):
    ...
    return render(request, 'index.html', {'thelist': thelist})
...
def addtocart(request, id):
    ...
    if cartm.objects.filter(pname=a.pname, userid=usd):
        return render(request,'alreadyinCart.html')
...
def wishlist(request, id):
    ...
    if wishlistm.objects.filter(pname=a.pname, userid=usd):
        return render(request,'alreadyWish.html')
...
def wishtocart(request, id):
    ...
    a = wishlistm.objects.get(id=id)
    if cartm.objects.filter(pname=a.pname,userid=ide):
        return render(request,'alreadyinCart.html')
